...
-- Criar banco de dados (nome do banco/sera dado na prova)
...
-- Inserir: usuarios --- inserir após o banco estar criado no workbanck---
...
-- Inserir: produtos /os codigos e nomes vão ser mudados de acordo com o tema da prova
